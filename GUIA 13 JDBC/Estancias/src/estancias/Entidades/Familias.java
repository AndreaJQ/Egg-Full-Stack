...
public class Familias {
    ...
    public Familias(Integer id_familia, String nombre, Integer edad_minima, Integer edad_maxima, Integer num_hijos, String email, Integer id_casa_familia) {
    ...
    public String toString() {
        return String.format("%-15s%-20s%-15s%-15s%-15s%-20s%-15s", id_familia , 

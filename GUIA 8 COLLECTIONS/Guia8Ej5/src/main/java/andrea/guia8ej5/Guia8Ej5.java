...
* se buscará el país en el conjunto y si está en el conjunto se eliminará el país que ingresó
* el usuario y se mostrará el conjunto. Si el país no se encuentra en el conjunto se le informará al usuario.
 */
package andrea.guia8ej5;

...
public class ServicioLibro {
    ...
    private ServicioAutor sma;
    private ServicioEditorial sme;
    
    public ServicioLibro(){
        this.control=new Controladora();
        this.scan=new Scanner(System.in).useDelimiter("\n");
        this.sma=new ServicioAutor();
        this.sme= new ServicioEditorial();
    }
    ...
    public Libro crearLibroMenu(){
        ...
        sma.mostrarListaAutores();//****************************************EDITAR MENU PARA LLEVAR A CREAR AUTOR Y CREAR EDITORIAL
